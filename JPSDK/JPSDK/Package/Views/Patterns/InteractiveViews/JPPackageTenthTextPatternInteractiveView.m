//
//  JPPackageTenthTextPatternInteractiveView.m
//  jper
//
...
@interface JPPackageTenthTextPatternInteractiveView(){
    JPPackageTenthTextPattern *textPatternView;
}

@end

@implementation JPPackageTenthTextPatternInteractiveView
...
- (void)setPatternAttribute:(JPPackagePatternAttribute *)patternAttribute{
    ...
    if (textPatternView == nil) {
        textPatternView = [[JPPackageTenthTextPattern alloc] initWithFrame:CGRectMake(0, 0, self.width, self.height)];
