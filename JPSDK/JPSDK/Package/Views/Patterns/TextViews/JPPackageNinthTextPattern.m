...
@interface  JPPackageNinthTextPattern()
...
@implementation JPPackageNinthTextPattern
...
- (void)createSubviews{
    [[NSBundle mainBundle] loadNibNamed:@"JPPackageNinthTextPattern" owner:self options:nil];
...
- (void)setScale:(CGFloat)scale{
    ...
    self.tittleLbBottomLayoutConstraint.constant = 2*scale;
}
