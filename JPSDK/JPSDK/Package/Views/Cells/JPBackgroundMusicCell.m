...
- (void)setupUI{
    ...
    self.imgView.sd_layout.centerXEqualToView(self.contentView).topSpaceToView(self.contentView, 0).heightIs(ScreenFitFloat6(60)).widthEqualToHeight();
    ...
    self.txtLb.font = [UIFont pingFangFontWithSize:10];
    self.txtLb.textColor = [UIColor colorWithHex:0xc5c5c5];
    [self.contentView addSubview:self.txtLb];
    self.txtLb.sd_layout.topSpaceToView(self.imgView, ScreenFitFloat6(7)).centerXEqualToView(self.contentView).widthIs(ScreenFitFloat6(60)).heightIs(11);
}
